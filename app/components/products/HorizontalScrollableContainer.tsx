...
export function HorizontalScrollableContainer({
  ...
  const wheelHandler = (e: WheelEvent) => {
    ...
    spanRef.current!.scrollBy({ left: diff, top: 0, behavior: 'smooth' });
    e.preventDefault();
  };
  ...
  return (
    <div className="flex items-center">
      <span
        className="py-2 mt-2 flex flex-row flex-nowrap space-x-3 md:overflow-x-hidden overflow-x-auto cursor-grab touch-pan-x"
        ref={spanRef}
