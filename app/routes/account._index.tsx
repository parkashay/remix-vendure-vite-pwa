      ...
      <div className="space-y-10 p-4 mt-5">
        <div className="grid grid-cols-2 gap-4">
          <div className="col-span-2">
            <h3 className="text-sm text-zinc-600">E-Mail</h3>
            {emailSavedResponse ? (
              <span>
                <span className="italic text-gray-800">
                  {emailSavedResponse.newEmailAddress}
                </span>
                <span className="ml-2 bg-primary-100 text-xs font-medium mr-2 px-2.5 py-0.5 rounded">
          ...
          >
            ...
            <div className="gap-4 grid sm:grid-cols-2">
              ...
              {isEditing ? (
                ...
                <div>
                  <h3 className="text-sm text-zinc-600">Full Name</h3>
              ...
              <div>
                {isEditing ? (
                  <ValidatedInput label="Phone No." name="phoneNumber" />
                ) : (
                  <div>
                    <h3 className="text-sm text-zinc-600">Phone No.</h3>
